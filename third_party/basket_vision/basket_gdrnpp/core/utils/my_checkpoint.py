...
class MyCheckpointer(DetectionCheckpointer):
    ...
    def __init__(self, model, save_dir="", *, save_to_disk=None, prefix_to_remove=None, **checkpointables):
        ...
        parallel_wrappers = (DistributedDataParallel, DataParallel, _LiteModule)
        if ShardedDataParallel is not None:
            parallel_wrappers = parallel_wrappers + (ShardedDataParallel,)
