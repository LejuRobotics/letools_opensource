...
# Reduce noisy library logs during visualization
import logging as _py_logging
import matplotlib
from PIL import PngImagePlugin
matplotlib.set_loglevel('warning')
_py_logging.getLogger('matplotlib').setLevel(_py_logging.WARNING)
_py_logging.getLogger('PIL').setLevel(_py_logging.WARNING)
