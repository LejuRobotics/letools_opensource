OUTPUT_ROOT = 'output'
OUTPUT_DIR = 'output/gdrn/basket/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_basket'
EXP_NAME = ''
DEBUG = False
SEED = -1
...
MODEL = dict(
    DEVICE='cuda',
    WEIGHTS=
    '/project/gdrnpp_est/output/gdrn/basket/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_basket/model_final.pth',
...
EXP_ID = 'convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_basket_test'
RESUME = False
